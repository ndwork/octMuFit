...
function paperSims
  ...
  for i=1:numel(simMus)
    ...
    [I, z, z0, zR, muAlpha, muBeta, muL0, trueMu] = makePhantom2D( ...
          N,-1,z0_true,noiseProportion,simMus{i},[1]);
    dz = z(2) - z(1);
    dx = dz;
...
function simIndx_out = evalCodes( simIndx, I, z, z0, zR, fid, outDir, ...
  ...
  fprintf( fid, [filename, ', Vermeer, %8.3f, %8.3f, ', muString, ...
        ', ', thickString, ', %5.2e, %8.3f, %8.3f, %16.11f\n'], ...
        z0, z0_true, noiseProportion, meanEtbDepth, meanVDepth, timeTaken );
  simIndx = simIndx + 1;
