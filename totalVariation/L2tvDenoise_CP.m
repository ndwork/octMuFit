function [xn,costs] = L2tvDenoise_CP(b,params)
...
rho = 1;  % See deblur_simpleTV_CP_L2penalty.m.
...
%     ynp1_1 = max(ynp1_1,-1);
    ...
    cost = .5*sum(sum((Axnp1-b).^2)) + gamma*evalIsoNorm(Gxnp1); % THIS LINE HAS NOT BEEN CHECKED.
    costs = [costs,cost];    
